...
# 체크포인트로 확인
model=load_model(path+'keras28_mcp_08_kaggle_bank.hdf5') 
# 세이브 모델 확인
model=load_model(path+'keras28_mcp_save_08_kaggle_bank.h5')
...
#     mode='auto',
#     save_best_only=True,    
#     filepath=path+'keras28_mcp_08_kaggle_bank.hdf5'
#     )
...
# path='./_save/keras28_mcp/08_kaggle_bank/'
# model.save(path+'keras28_mcp_save_08_kaggle_bank.h5')
