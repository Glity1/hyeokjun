...
from tensorflow.python.keras.layers import Dense, LSTM, Dropout, Conv1D, Flatten, MaxPooling2D, BatchNormalization, Activation
...
# 3. 모델 구성
model = Sequential([
    Conv1D(32, 2, input_shape=(200,200, 3), padding='same'),
...
# val_loss: 2.4980, val_acc: 0.6845