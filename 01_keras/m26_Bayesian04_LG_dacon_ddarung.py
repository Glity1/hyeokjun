...
# 최적의 값 :  {'target': 0.759474053436711, 'params': {'n_estimators': 446.91276035503466, 'learning_rate': 0.5, 'max_depth': 10.0, 'num_leaves': 94.83951282872009, 'min_child_samples': 5.0, 'feature_fraction': 0.5, 'bagging_fraction': 0.6589296477997245, 'lambda_l2': 100.0, 'lambda_l1': 0.0, 'min_gain_to_split': 0.0}}
# 50  번 걸린 시간 :  27.26 초