...
# 3. 피처 추출 함수: Fingerprint + 확장된 Descriptor
...
y = train['Inhibition'].values  # 🚫 로그 변환 제거
...
submit_path = './_save/dnn_top20_nolog_submission.csv'
submit.to_csv(submit_path, index=False)
print(f"📁 제출 파일 저장 완료: {submit_path}")

# 12. 모델 및 객체 저장
model.save('./_save/dnn_top20_nolog_model.h5')
joblib.dump(scaler, './_save/dnn_top20_nolog_scaler.pkl')
joblib.dump(selector, './_save/dnn_top20_nolog_selector.pkl')
