...
hist = model.fit(x_train, y_train, epochs=300, batch_size=256, validation_split=0.2,
...
submission_csv.to_csv(path + 'submission_adaptive_dropout_nosmote.csv')
print("✅ 제출파일 저장 완료!")
