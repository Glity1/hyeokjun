...
weight_multiplier = 3.0 # 이 값을 2.5, 3.0 등으로 조절하며 실험
...
target_recall_threshold_dl = 0.60 # 딥러닝 모델의 목표 재현율 설정 (예: 70%)
...
target_recall_threshold_ensemble = 0.75 # 앙상블 모델의 목표 재현율 설정 (예: 75%)
