...
input1 = Input(shape=(10,))       # 대문자 클래스 를 인스턴스화 한다.
dense1 = Dense(64, name='layer_1')(input1)       # (input) = input 에서 받아들인다 
...
dense6 = Dense(32, name='layer_6', activation='relu')(drop5)
drop6 = Dropout(0.2)(dense4)
dense7 = Dense(32, name='layer_7', activation='relu')(drop6)
drop7 = Dropout(0.2)(dense4)
...
mcp=ModelCheckpoint(
    ...
    mode='auto',
    save_best_only=True,    
    filepath=path+'keras35_mcp_03_diabetes.hdf5'
    )
...
path='./_save/keras28_mcp/03_diabetes/'
model.save(path+'keras35_mcp_save_03_diabetes.h5')
