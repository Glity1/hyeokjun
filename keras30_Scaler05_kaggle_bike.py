...
# 체크포인트로 확인
model=load_model(path+'keras28_mcp_05_kaggle_bike.hdf5') 
# 세이브 모델 확인
model=load_model(path+'keras28_mcp_save_05_kaggle_bike.h5')
...
scaler=MinMaxScaler()
loss :  46593.69140625
r2 :  -0.4438561185593459
RMSE :  215.8557154565079

scaler=StandardScaler()
loss :  46817.70703125
r2 :  -0.45079817519919496
RMSE :  216.3740100862118

scaler=MaxAbsScaler()
loss :  46104.53515625
r2 :  -0.428698007899335
RMSE :  214.7196612073998

scaler=RobustScaler()
loss :  46504.71875
r2 :  -0.4410990145758906
RMSE :  215.64952419323583
          
"""          


# 집가서 다시 만들것... time 관련해서는 save 쪽에 써도 상관없다