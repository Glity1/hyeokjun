...
#    최적의 값 :  {'target': 0.9125059596373849, 'params': {'n_estimators': 100.0, 'learning_rate': 0.5, 'max_depth': 3.0, 'num_leaves': 100.0, 'min_child_samples': 5.0, 'feature_fraction': 1.0, 'bagging_fraction': 0.5, 'lambda_l2': 0.0, 'lambda_l1': 0.0, 'min_gain_to_split': 0.0}}
# 50  번 걸린 시간 :  22.7 초