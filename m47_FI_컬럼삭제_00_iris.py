...
print('acc1 : ', model.score(x_test, y_test))   # acc :   0.9333333333333333
print(model.feature_importances_)    


print(" 25% 지점 :  ", np.percentile(model.feature_importances_, 34))
#  25% 지점 : 0.015206812880933285

percentile = np.percentile(model.feature_importances_, 34)
...
model.fit(x_train, y_train)
print('acc2 : ', model.score(x_test, y_test))   # acc2 :  0.9666666666666667
