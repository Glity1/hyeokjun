...
# print(x_train.shape, y_train.shape)                # (100000, 32, 32, 3) (100000, 3)
...
#2. 모델구성
model = Sequential()
model.add(Conv2D(128, (2,2), strides=1, padding='same', input_shape=(32, 32, 3)))
...
hist = model.fit(x_train, y_train, epochs=100, batch_size=128,    # 60000장을 64장 단위로 훈련
                 verbose=1,
...
# loss :  1.0005528926849365
# acc :  0.6478000283241272
# accuracy_score :  0.6478

# 증강 후
# loss :  1.2710025310516357
# acc :  0.5544000267982483
# accuracy_score :  0.5544