...
x_train = x_train.reshape(1167,1,1,9)
x_test = x_test.reshape(292,1,1,9)

#2. 모델구성
model = Sequential()
model.add(Conv2D(64, (2,2), strides=1, padding='same', input_shape=(1, 1, 9)))
...
# loss :  2152.410888671875
# r2 :  0.7208490690219684
# RMSE :  46.39408446634921