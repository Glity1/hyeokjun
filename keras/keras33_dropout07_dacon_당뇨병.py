...
mcp=ModelCheckpoint(
    ...
    mode='auto',
    save_best_only=True,    
    filepath=path+'keras33_mcp_07_dacon_당뇨병.hdf5'
    )
...
path='./_save/keras28_mcp/07_dacon_당뇨병/'
model.save(path+'keras33_mcp_save_07_dacon_당뇨병.h5')
...
[0.5527930855751038, 0.6717557311058044]
loss :  0.5527930855751038
accuracy :  0.67176
(131,) (131, 1)
(131, 1)
