...
from tensorflow.keras.layers import Conv1D, MaxPooling2D, BatchNormalization, Activation, Dropout, Flatten, Dense
...
# print(y_train.shape, y_test.shape)  #(20000, 100, 100, 3) (5000, 100, 100, 3)
# exit()
...
# 3. 모델 구성
model = Sequential([
    Conv1D(32, 2, padding='same', input_shape=(100*100, 3)),
