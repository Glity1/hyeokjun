...
# 🔸 데이터 경로 설정
path_train = './_data/tensor_cert/horse-or-human/train'
path_test = './_data/tensor_cert/horse-or-human/test'
...
np.save(np_path + "keras46_03_x_train.npy", arr=x)  # 이미지 데이터 저장
np.save(np_path + "keras46_03_y_train.npy", arr=y)  # 라벨 데이터 저장
