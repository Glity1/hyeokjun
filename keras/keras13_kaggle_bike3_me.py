#1. train.csv와 new_test.csv로 count 예측
...
# #################### x,y 데이터를 분리한다 ##########################
print('###############################################################################')
x = train_csv.drop(['count'], axis=1)   # axis=1 컬럼 // count만 삭제
...
######################## csv파일 만들기 ######################
samplesubmission_csv.to_csv(path + 'samplesubmission_0522_1736.csv', index=False) # csv 만들기.
