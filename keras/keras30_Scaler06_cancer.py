...
# 체크포인트로 확인
model=load_model(path+'keras28_mcp_06_cancer.hdf5') 
# 세이브 모델 확인
model=load_model(path+'keras28_mcp_save_06_cancer.h5')
...
#     mode='auto',
#     save_best_only=True,    
#     filepath=path+'keras28_mcp_06_cancer.hdf5'
#     )
...
scaler=MinMaxScaler()
loss :  0.6719902157783508
accuracy :  0.63158

scaler=StandardScaler()
loss :  0.6781488656997681
accuracy :  0.61404

scaler=MaxAbsScaler()
loss :  0.6685907244682312
accuracy :  0.63158

scaler=RobustScaler()
loss :  0.6703354716300964
accuracy :  0.63158
