...
model_save_path = f'./_save/gnn_edge{Config.edge_feat_dim}_stereo1hot_morgan{Config.use_topN}_log1p_scaled_rdkit.pt' # ⭐️ 파일명 변경
...
submission_file_name = f'./_save/gnn_edge{Config.edge_feat_dim}_stereo1hot_morgan{Config.use_topN}_log1p_scaled_rdkit_submission.csv' # ⭐️ 파일명 변경
