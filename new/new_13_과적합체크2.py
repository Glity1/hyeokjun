...
# 3. 피처 생성 함수 (2048 FP + 20+ Descriptor)
...
# submit_path = './_save/dnn_top50_submission.csv'
# submit.to_csv(submit_path, index=False)
# print(f"📁 제출 파일 저장 완료: {submit_path}")

# # 12. 저장
# model.save('./_save/dnn_top50_model.h5')
# joblib.dump(scaler, './_save/dnn_top50_scaler.pkl')
# joblib.dump(selector, './_save/dnn_top50_selector.pkl')
