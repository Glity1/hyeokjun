...
print(x_train.shape, x_test.shape)  #(512, 30) (57, 30)
print(y_train.shape, y_test.shape)  #(512,) (57,)
...
x_train = x_train.reshape(512,5,2,3)
x_test = x_test.reshape(57,5,2,3)

#2. 모델구성
model = Sequential()
model.add(Conv2D(64, (2,2), strides=1, padding='same', input_shape=(5, 2, 3)))
