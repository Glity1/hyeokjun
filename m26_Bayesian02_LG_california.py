...
# 최적의 값 :  {'target': 0.8489946497052241, 'params': {'n_estimators': 473.09290087155057, 'learning_rate': 0.5, 'max_depth': 10.0, 'num_leaves': 26.95491955578328, 'min_child_samples': 17.200931708483928, 'feature_fraction': 1.0, 'bagging_fraction': 1.0, 'lambda_l2': 73.61365090181569, 'lambda_l1': 10.0, 'min_gain_to_split': 0.0}}
# 30  번 걸린 시간 :  23.48 초