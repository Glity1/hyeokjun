...
# 최적의 값 :  {'target': 1.0, 'params': {'n_estimators': 291.0577542929424, 'learning_rate': 0.5, 'max_depth': 3.0, 'num_leaves': 56.549370523740215, 'min_child_samples': 13.336089389949684, 'feature_fraction': 1.0, 'bagging_fraction': 1.0, 'lambda_l2': 30.843775658038002, 'lambda_l1': 0.22085270935260143, 'min_gain_to_split': 0.0}}
# 50  번 걸린 시간 :  35.07 초