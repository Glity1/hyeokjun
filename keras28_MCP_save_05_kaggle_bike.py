...
model.save_weights(path+'keras28_MCP_save_05_kaggle_bike.h5')
...
mcp=ModelCheckpoint(
    ...
    mode='auto',
    save_best_only=True,    
    filepath=path+'keras28_mcp_05_kaggle_bike.hdf5'
    )
...
path='./_save/keras28_mcp/05_kaggle_bike/'
model.save(path+'keras28_mcp_save_05_kaggle_bike.h5')
